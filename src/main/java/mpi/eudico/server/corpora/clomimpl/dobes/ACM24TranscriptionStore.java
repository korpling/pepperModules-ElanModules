...
/**
 * A TranscriptionStore that corresponds to EAF v2.4.<br>
 * Version 2.4 extends v2.3 by adding support for ANNOTATOR attribute of TIER and 
 * for generic document level Properties.
 *
 * @see EAF23TranscriptionStore
 * 
 ...
 */
public class ACM24TranscriptionStore implements TranscriptionStore, ServerLogger {
    ...
    /**
     * Creates a new ACM24TranscriptionStore instance
     */
    public ACM24TranscriptionStore() {
        super();
		//debug = true;
    }
    ...
    public void storeTranscriptionIn(Transcription theTranscription, EncoderInfo encoderInfo,
		...
		switch (format) {
			case TranscriptionStore.EAF:
				...
				new EAF24Encoder().encodeAndSave(theTranscription, null, tierOrder, path);			
				break;
    ...
    public void storeTranscriptionAsTemplateIn(Transcription theTranscription,
        ...
        new EAF24Encoder().encodeAsTemplateAndSave(theTranscription, tierOrder, path);
    }
    ...
    public void loadTranscription(Transcription theTranscription, DecoderInfo decoderInfo) {
		...
		if (lowerPathName.endsWith("cha")) {
			...
			parser = ParserFactory.getParser(ParserFactory.EAF24);
		}
 ...
 //           typesCopy.add(i, linguisticTypes.get(i));
        ...
        while (tierIter.hasNext()) {
            ...
            while (it1.hasNext()) {
                ...
                // check value of id, may not be neccesary if the highest id value is strored in the xml file
