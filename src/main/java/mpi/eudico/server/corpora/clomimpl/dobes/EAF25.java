...
public class EAF25 {
	...
	*/
	...
	public final Element newAnnotationDocument
		...
		result.setAttribute("xsi:noNamespaceSchemaLocation", "http://www.mpi.nl/tools/elan/EAFv2.5.xsd");
		result.setAttribute("DATE",   creationDate);
		result.setAttribute("AUTHOR", author);
		result.setAttribute("VERSION", version);
		result.setAttribute("FORMAT", "2.5");
		return result;
    }
	...
	public final Element newHeader (String mediaFile) {
		if (mediaFile == null) throw new RuntimeException("EAF");
		return newHeader(mediaFile, EAF25.TIME_UNIT_MILLISEC);
    }
     ...
     */
    public final Element newMediaDescriptor(String mediaURL, String relMediaURL,
     ...
     */
    public final Element newLinkedFileDescriptor(String linkURL, String relLinkURL,
     ...
     */
    public final Element newProperty(String name, String value) {
