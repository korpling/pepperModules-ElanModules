...
public class EAF23 {
	...
	*/
	...
	public final Element newAnnotationDocument
		...
		result.setAttribute("xsi:noNamespaceSchemaLocation", "http://www.mpi.nl/tools/elan/EAFv2.3.xsd");
		result.setAttribute("DATE",   creationDate);
		result.setAttribute("AUTHOR", author);
		result.setAttribute("VERSION", version);
		result.setAttribute("FORMAT", "2.3");
		return result;
    }
	...
	public final Element newHeader (String mediaFile) {
		if (mediaFile == null) throw new RuntimeException("EAF");
		return newHeader(mediaFile, EAF23.TIME_UNIT_MILLISEC);
    }
	...
	*/
	...
	/**
	   Testing the class.
	 */
    public EAF23(boolean test) throws Exception {
		this();

		//test...
		Element e = newAnnotationDocument(new Date()+"", "gregor", "version 2.3");
		appendChild(e);
