...
public class EAF27 {
	...
	*/
	...
	public Element newAnnotationDocument
		...
		result.setAttribute("FORMAT", "2.7");
		return result;
    }
	...
	public Element newHeader (String mediaFile) {
		if (mediaFile == null) throw new RuntimeException("EAF");
		return newHeader(mediaFile, EAF27.TIME_UNIT_MILLISEC);
    }
...
// TO DO add EXT REF
	...
	/**
	   ...
	   @param extRefId the ref to the id of an EXTERNAL_REF element
	 * @param lexiconQueryBundleName 
	 */
	public Element newLinguisticType (String id, boolean timeAlignable, 
		boolean graphicReferences, String constraint, String controlledVocabularyName, String extRefId, String lexiconQueryBundleName){
		if (id == null) throw new RuntimeException("EAF");
		// TO DO add EXT REF
		...
		if (lexiconQueryBundleName != null) {
			result.setAttribute("LEXICON_REF", lexiconQueryBundleName);
		}
...
//	}
	...
	public Element newControlledVocabulary (String conVocId, String description, String extRef) {
		Element result = newControlledVocabulary(conVocId, description);
		if (extRef != null) {
			result.setAttribute("EXT_REF", extRef);
		}
		return result;
	...
	/**
	 * For Lexicon connection
	 * 
	 * @param id, queryBundle
	 * @return Element
	 */
