...
public class EAF21 {
	...
	*/
	...
	public final Element newAnnotationDocument
		...
		result.setAttribute("xsi:noNamespaceSchemaLocation", "http://www.mpi.nl/tools/elan/EAFv2.1.xsd");
		result.setAttribute("DATE",   creationDate);
		result.setAttribute("AUTHOR", author);
		result.setAttribute("VERSION", version);
		result.setAttribute("FORMAT", "2.1");
		return result;
    }
	...
	*/
	...
	/**
	   Testing the class.
	 */
    public EAF21(boolean test) throws Exception {
		this();
