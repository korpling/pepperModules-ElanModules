...
/**
   ...
   <p>
   You explicitely have to add the ANNOTATION_DOCUMENT to the DAF DOM:
   <code>
   ...
   System.out.println("<!DOCTYPE Trans SYSTEM \"DAF.dtd\">");
   System.out.println(""+daf.getDocumentElement());
   </code>
   WRONG!!!!!!!!!!
   <br> See Annotation_Document.writeDown()
...
public class DAF {
	...
	/**
	   DAF is per se a subtype of org.w3c.dom.Document.
	...
	*/
	...
	public final Element newAnnotationDocument
		...
		if (creationDate == null) throw new RuntimeException("DAF");
		if (author == null) throw new RuntimeException("DAF");
		if (version == null) throw new RuntimeException("DAF");
	...
	public final Element newHeader (String mediaFile, String timeUnits) {
		if (mediaFile == null) throw new RuntimeException("DAF");
		if (timeUnits == null) throw new RuntimeException("DAF");
	...
	public final Element newHeader (String mediaFile) {
		if (mediaFile == null) throw new RuntimeException("DAF");
		return newHeader(mediaFile, DAF.TIME_UNIT_MILLISEC);
    }
	/**
	   Use result in annotationDocument.appendChild();
	...
	public final Element newTimeSlot (String id, long time) {
		if (id == null) throw new RuntimeException("DAF");
	...
	public final Element newTier 
		(String id, 
		 ...
		 String parent) {
		if (id == null) throw new RuntimeException("DAF");
		if (typeRef == null) throw new RuntimeException("DAF");
		if (language == null) throw new RuntimeException("DAF");
	...
	public final Element newRefAnnotation 
		...
		if (id == null) throw new RuntimeException("DAF");
		if (annotationRef == null) throw new RuntimeException("DAF");
	...
	public final Element newAnnotationValue (String value) {
		if (value == null) throw new RuntimeException("DAF");
	...
	public final Element newLocale (Locale l){
		if (l == null) throw new RuntimeException("DAF");
