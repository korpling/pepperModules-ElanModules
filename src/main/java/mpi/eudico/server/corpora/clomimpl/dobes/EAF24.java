...
public class EAF24 {
	...
	*/
	...
	public final Element newAnnotationDocument
		...
		result.setAttribute("xsi:noNamespaceSchemaLocation", "http://www.mpi.nl/tools/elan/EAFv2.4.xsd");
		result.setAttribute("DATE",   creationDate);
		result.setAttribute("AUTHOR", author);
		result.setAttribute("VERSION", version);
		result.setAttribute("FORMAT", "2.4");
		return result;
    }
	...
	public final Element newHeader (String mediaFile) {
		if (mediaFile == null) throw new RuntimeException("EAF");
		return newHeader(mediaFile, EAF24.TIME_UNIT_MILLISEC);
    }
     ...
     */
    public final Element newLinkedFileDescriptor(String linkURL, 
    ...
    /**
     * Introduced in EAF version 2.4. Document level property with an optional 
