...
/**
 * Encodes a Transcription to EAF 2.3 format and saves it.
 *
...
public class EAF23Encoder implements AnnotationDocEncoder {
    ...
    public static Element createDOM(Transcription theTranscription,
        ...
        if (attisTr == null) {
            LOG.warning(
                "[[ASSERTION FAILED]] ACM23TranscriptionStore/storeTranscription: theTranscription is null");
        }
    ...
    public static Element createTemplateDOM(Transcription theTranscription,
        ...
        if (attisTr == null) {
            LOG.warning(
                "[[ASSERTION FAILED]] ACM22TranscriptionStore/storeTranscription: theTranscription is null");
        }
