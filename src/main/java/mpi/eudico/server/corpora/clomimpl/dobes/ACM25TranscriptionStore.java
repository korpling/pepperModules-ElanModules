...
/**
 * A TranscriptionStore that corresponds to EAF v2.5.<br>
 * Version 2.5 extends v2.4 by adding support for attribute RELATIVE_MEDIA_URL of
 * MEDIA_DESCRIPTOR and RELATIVE_LINK_URL of LINKED_FILE_DESCRIPTOR
 *
 ...
 */
public class ACM25TranscriptionStore implements TranscriptionStore, ServerLogger {
    ...
    /**
     * Creates a new ACM25TranscriptionStore instance
     */
    public ACM25TranscriptionStore() {
        super();
		//debug = true;
    }
    ...
    public void loadTranscription(Transcription theTranscription, DecoderInfo decoderInfo) {
		...
		if (lowerPathName.endsWith("cha")) {
			...
			parser = ParserFactory.getParser(ParserFactory.EAF25);
		}
