    ...
    public void undo() {
        ...
        if (simpleMerge) {
            ...
            if (tier != null) {
                ...
                if (aa2 != null) {
                    aa2.setValue(mergeAnnRecord.getValue());
                    aa2.setId(mergeAnnRecord.getId());

                    if (aa2 instanceof SVGAlignableAnnotation &&
                    		mergeAnnRecord instanceof SVGAnnotationDataRecord) {
                        SVGAnnotationDataRecord svgRec = (SVGAnnotationDataRecord) mergeAnnRecord;
                    ...
                    if (mergeAnnRecord.getExtRef() != null) {
                        aa2.setExtRef(mergeAnnRecord.getExtRef());
                    }
                }
            } else {
        ...
        if ((arguments.length > 0) &&
            ...
            if (mergeAnn != null  && aa !=null) {
                if ((aa.getParentListeners().size() == 0) &&
                    ...
                    if (mergeAnn instanceof SVGAlignableAnnotation) {
                    	mergeAnnRecord = new SVGAnnotationDataRecord((SVGAlignableAnnotation) mergeAnn);
                    } else {
