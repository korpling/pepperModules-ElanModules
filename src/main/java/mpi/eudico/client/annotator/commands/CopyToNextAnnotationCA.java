...
public class CopyToNextAnnotationCA extends CommandAction {
    ...
    protected Object[] getArguments() {
        Vector simultaneousAnnotations = getSimultaneousAnnotations(currentAnnot);
    ...
    private Vector getSimultaneousAnnotations(Annotation currentActiveAnnot) {
        ...
        extractRootTiers(vm.getTranscription(), rootTiers);

        Vector simultaneousAnnotations = null;

        if (currentActiveAnnot != null) {
            TierImpl currentTier = (TierImpl) currentActiveAnnot.getTier();

            simultaneousAnnotations = new Vector();
