    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (arguments != null) {
            ...
            if (tier != null) {
            	...
            	List<Tier> allTiers = transcription.getTiers();
                TierImpl tier2 = null;
    ...
    private void storeAnnotationTrees(TierImpl tier, long begin, long end) {
        ...
        if (tier != null) {
	        ...
	        for (int i = 0; i < annos.size(); i++) {
	            annotation = (AbstractAnnotation) annos.get(i);
        	...
        	if (rootTiers != null && rootTiers.size() > 0) {
        		...
        		for (String tName : rootTiers) {
        			tier2 = (TierImpl) transcription.getTierWithId(tName);
        			if (tier2 != null) {
        		        List annos = tier2.getAnnotations();
