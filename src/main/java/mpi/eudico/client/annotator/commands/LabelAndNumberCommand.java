...
public class LabelAndNumberCommand implements UndoableCommand, ClientLogger {
     ...
     * @param arguments the arguments: <ul><li>arg[0] = the selected tiers
     *        (ArrayList)</li> <li>arg[1] = the prefix part (can be null)
     *        (String)     </li> <li>arg[2] = the number format can be
     *        null(Integer or Double)</li> <li>arg[3] = the number of integer
     *        digits (can be null) (Integer) </li> <li>arg[4] = the start
     *        value (can be null) (Integer or Double) </li> <li>arg[5] = the
     *        increment (can be null) (Integer or Double)</li> </ul>
     */
    ...
    private void changeAnnotationValues() {
        ...
        if ((tierNames == null) || (tierNames.size() == 0)) {
            ...
            if (tier == null) {
                LOG.warning("The tier " + (String) tierNames.get(0) +
                    " does not exist.");
                transcription.setNotifying(true);
                setWaitCursor(false);
        ...
        records = new ArrayList(anns.size());
        ...
        if (numberCountPart) {
            if (startIntValue > -1) {
                if (numDigits == 1) {
                    ...
                    StringBuffer sb = new StringBuffer(String.valueOf(startIntValue +
                                (count * intIncr)));
                ...
                if (numDigits == 1) {
                    ...
                    StringBuffer sb = new StringBuffer(String.valueOf(nd));
