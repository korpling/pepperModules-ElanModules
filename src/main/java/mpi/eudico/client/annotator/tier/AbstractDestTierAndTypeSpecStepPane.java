...
//		destinationTierConfigurationPanel.add(parentTierCB, gbc);
		...
		if (!multiFileMode) {	
			...
			Object storedPref = Preferences.get("DestinationType.HideTypesWithCV", null);
			if (storedPref instanceof Boolean) {
				hideTypesWithCVCB.setSelected((Boolean) storedPref);
			}
	...
	public boolean leaveStepForward(){
		...
		if (!multiFileMode) {
			Preferences.set("DestinationType.HideTypesWithCV", new Boolean(hideTypesWithCVCB.isSelected()), 
				null, false, false);
		}
