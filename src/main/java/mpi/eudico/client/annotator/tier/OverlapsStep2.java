...
public class OverlapsStep2 extends StepPane{
	...
	private JRadioButton overlapRB, valuesTheSameRB, valuesDifferentRB, valuesMatchConstraintsRB;	
    ...
    public boolean leaveStepForward() {    	
        ...
        if(tierValueTable != null)
        {       	
        	 DisplayableContentTableModel m = (DisplayableContentTableModel) tierValueTable.getModel();
        ...
        multiPane.putStepProperty("tierValueConstraints", tierValuePairs);
	...
	private class ButtonListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if( btn == valuesMatchConstraintsBtn ){
				ClosableDialog dialog = new ConstraintDialog();
