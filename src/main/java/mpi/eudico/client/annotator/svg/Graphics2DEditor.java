...
public class Graphics2DEditor extends JDialog implements ActionListener, ItemListener {
    ...
    private float msPerFrame = 40f; //initial value is the PAL value
    ...
    protected void loadPreferences() {
    	Rectangle dialogBounds = (Rectangle) Preferences.get("GraphicsEditorBounds", null);
        ...
        Object edBounds = Preferences.get("EditorIFrameBounds", null);
        if (edBounds instanceof Rectangle && editFrame != null) {
        	editFrame.setBounds((Rectangle) edBounds);
        }
        Object zoomLev = Preferences.get("GraphicsEditorZoom", null);
        if (zoomLev instanceof Integer) {
        	editorPanel.setZoom(((Integer) zoomLev).intValue());
        	//update menu
        	if (zoomBox != null) {
    ...
    protected void savePreferences() {
        ...
        if (editorPanel != null) {
        	Preferences.set("GraphicsEditorZoom", new Integer(editorPanel.getZoom()), null);
        }
    }
