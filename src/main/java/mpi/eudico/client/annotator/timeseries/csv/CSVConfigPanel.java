...
public class CSVConfigPanel extends TSConfigPanel implements ActionListener,
    ...
    private void initComponents() {
        ...
        timeColSpinModel.setMinimum(new Integer(1)); // 1 based
        timeColSpinModel.setMaximum(new Integer(1000)); // estimation of max.
        ...
        colSpinModel.setMinimum(new Integer(1));
        colSpinModel.setMaximum(new Integer(1000));
    ...
    private void updateForTrack(String trackName) {
        ...
        if (currentTrack != null) {
            ...
            if (spos != null) {
                ...
                if (cols.length >= 1) {
                    colSpinner.setValue(new Integer(cols[0] + 1)); // from 0 based to 1 based
                } else {
                    colSpinner.setValue(colSpinModel.getMinimum());
                }
            }
    ...
    private AbstractTSTrack createTrack(int timeCol, int dataCol, int derLevel,
        ...
        if (continuousRate) {
            ...
            try {
                track.setData(reader.readTrack(timeCol, dataCol, derLevel,
                        continuousRate));
