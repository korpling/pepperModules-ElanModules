...
//	}
	 ...
	 */
	public int addOriginalTier(String name, String type, String annotator,
			String participant, String parent) throws InconsistentChildrenException {
		...
		if(o_tier != null) {
			...
			if(parent != null && !parent.equals("")) {
				...
				Iterator it = tier_children.keySet().iterator();
				while(it.hasNext()) {
	...
	public int addType(String name, String dataCategory, 
