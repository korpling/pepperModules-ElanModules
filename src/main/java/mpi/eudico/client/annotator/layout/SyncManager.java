...
public class SyncManager implements ActionListener, ItemListener, ChangeListener, ModeLayoutManager {
    ...
    public SyncManager(ViewerManager2 viewerManager,
        ...
        playerList = new ArrayList(layoutManager.getPlayerList());
    ...
    private JPanel getVolumeRatePanel() {
    	...
    	int volume = (int)(viewerManager.getMasterMediaPlayer().getVolume() * 100);
   ...
   private void resetOffsets() {
    ...
    public void reconnect() {
       ...
       // container.add(mediaPlayerController.getTimePanel());
        if (playerList.size() > 0) {
			viewerManager.setMasterMediaPlayer(((PlayerLayoutModel) playerList.get(0)).player);
	...
	public void stateChanged(ChangeEvent e) {
		if (e.getSource() == volSlider) {
			...
			viewerManager.getMasterMediaPlayer().setVolume(((float) volume / 100));
    ...
    public void doLayout() {
        ...
        getPlayerSelectionPanel().setBounds(playerSelectionX,
            playerSelectionY, 
            playButtonsX - COMP_MARGIN - layoutManager.CONTAINER_MARGIN - playerSelectionX,
