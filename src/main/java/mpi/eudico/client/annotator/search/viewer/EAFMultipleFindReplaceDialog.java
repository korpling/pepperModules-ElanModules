...
public class EAFMultipleFindReplaceDialog extends JDialog
    ...
    private void initComponents() {
        ...
        caseSensitiveCheckBox.setFont(caseSensitiveCheckBox.getFont()
                                                           .deriveFont(Font.PLAIN,
                9f));
        regexCheckBox = new JCheckBox();
        regexCheckBox.setFont(regexCheckBox.getFont().deriveFont(Font.PLAIN, 9f));
    ...
    protected ArrayList<File> getMultipleFiles(JFrame parent, String title) {
    	...
    	searchDirs = (ArrayList<String>) mfDialog.getSearchDirs();// neccessary?
    	searchPaths = (ArrayList<String>) mfDialog.getSearchPaths();//neccessary?
    ...
    private void start() {
        ...
        Boolean regEx = new Boolean(regexCheckBox.isSelected());
        Boolean caseSens = new Boolean(caseSensitiveCheckBox.isSelected());
        ...
        if (selectedTiersRB.isSelected() && (selTiersList != null)) {
            selTiers = (String[]) selTiersList.toArray(new String[] {  });
        }
