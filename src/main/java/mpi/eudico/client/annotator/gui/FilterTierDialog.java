...
public class FilterTierDialog extends AbstractTwoTierOpDialog {
    ...
    private void loadPreferences() {
    	...
    	val = Preferences.get("FilterDialog.Overwrite", null);
    	...
    	val = Preferences.get("FilterDialog.ProcessEmptyAnnotations", null);
    	if (val instanceof Boolean) {
        ...
        public void actionPerformed(ActionEvent e) {
            if ((filterList != null) &&
                ...
                for (int i = 0; i < selObjects.length; i++) {
                    ((DefaultListModel) filterList.getModel()).removeElement(selObjects[i]);
                }
            }
        }
    }
