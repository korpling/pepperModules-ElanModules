 ...
 * Source: http://tips4java.wordpress.com/2009/02/01/menu-scroller/
 */
 ...
 * <P>
 * This version is adapted from the file available at tips4java.
 * 
 * @author Darryl Burke
 */
public class MenuScroller {
  ...
  private class MenuScrollTimer extends Timer {
    ...
    public MenuScrollTimer(final int increment, int interval, final MenuScroller menuScroller) {
      super(interval, new ActionListener() {

    	public void actionPerformed(ActionEvent e) {
          menuScroller.firstIndex += increment;
          menuScroller.refreshMenu();
        }
      });
    }
  }
  ...
  private class MenuScrollItem extends JMenuItem
    ...
    public MenuScrollItem(MenuIcon icon, int increment) {
      ...
      timer = new MenuScrollTimer(increment, interval, MenuScroller.this);
