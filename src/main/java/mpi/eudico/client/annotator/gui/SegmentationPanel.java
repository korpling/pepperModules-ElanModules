...
//                    "SegmentationDialog.Title")));
    ...
    private void readPreferences() {
    	...
    	pref = Preferences.get("SegmentationMode.MarkBegin", null);
    	if (pref instanceof Boolean) {
    		singleStrokeIsBegin = (Boolean) pref;
    	...
    	pref = Preferences.get("SegmentationMode.FixedDuration", null);
    	...
    	pref = Preferences.get("SegmentationMode.DelayMode", null);
    	if (pref instanceof Boolean) {
    		delayCB.setSelected((Boolean) pref);
    		delayTF.setEnabled((Boolean) pref);
    	}
    	
    	pref = Preferences.get("SegmentationMode.DelayDuration", null);
    	if (pref instanceof Long) {
    		delayTF.setText(String.valueOf((Long) pref));
    		if (delayCB.isSelected()) {
    			viewer.setDelayDuration((Long) pref);
    		}
    	}
    }
