...
public class AnnotationStatisticsPanel2 extends AbstractStatisticsPanel
        ...
        if (transcription != null) {
            ...
            if (curTier == null) {
                ...
                if (tier != null) {
                    ...
                    TreeSet annos = getAnnotationValues(tier);
                    int numRows = 0;
                    ...
                    if ((annos != null) && (annos.size() > 0)) {
                        ...
                        int i = 0;
                        Iterator itAnnValues = annos.iterator();

                        while (itAnnValues.hasNext()) {
                            String value = (String) itAnnValues.next();
    ...
    private String[] getRowForValue(TierImpl tier, String annValue) {
        ...
        row[4] = format.format((totalDur / (float) numOcc) / 1000);
