...
public class ElanSlider extends JComponent implements ElanLocaleListener {
    ...
    private Vector getAllowed() {
        Vector vecReturn = new Vector();

        vecReturn.add(new Character('1'));
        vecReturn.add(new Character('2'));
        vecReturn.add(new Character('3'));
        vecReturn.add(new Character('4'));
        vecReturn.add(new Character('5'));
        vecReturn.add(new Character('6'));
        vecReturn.add(new Character('7'));
        vecReturn.add(new Character('8'));
        vecReturn.add(new Character('9'));
        vecReturn.add(new Character('0'));
    ...
    */
    ...
    private void updateSlider(ElanSlider elanslider, int value) {
        ...
        if (name != null) {
            if (name.equals("ELANSLIDERRATE")) {
                ...
                vm.getMasterMediaPlayer().setVolume((float) value / 100);
    ...
    /**
     * DOCUMENT ME!
     * $Id: ElanSlider.java 15554 2009-07-07 13:07:49Z hasloe $
     * @author $Author$
     * @version $Revision$
     */
