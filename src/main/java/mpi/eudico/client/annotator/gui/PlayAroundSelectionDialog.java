...
//                                                    .getMilliSecondsPerSample());
        	curValue = (int) (slider.getValue() * 40);// use a default of 40 ms per frame
        ...
        if (e.getSource() == okButton) {
            if (slider != null) {
                ...
                if (value != action.getPlayAroundSelectionValue()) {
                    ...
                    c.execute(action, new Object[] { new Integer(value) });
                }
                */
            }
        }
