...
public class ExportWordListDialog extends AbstractExtTierExportDialog 
     ...
     */
    public ExportWordListDialog(Frame parent, boolean modal, ArrayList<File> files) {
     ...
     */
    public ExportWordListDialog(Frame parent, boolean modal, ArrayList<File> files, int mode) {
    ...
    protected void extractTiers() {
    	...
    	Object useTyp = Preferences.get("ExportWordListDialog.TierOrder", transcription);
        ...
        useTyp = Preferences.get("ExportWordListDialog.selectedTiers", transcription);
        if (useTyp instanceof List) {
        	//loadTierPreferences((List)useTyp);
        	setSelectedTiers((List)useTyp);
        }
        
        useTyp = Preferences.get("ExportWordListDialog.SelectTiersMode", transcription);
        if (useTyp instanceof String) {
        	...
        	if (!AbstractTierSortAndSelectPanel.BY_TIER.equals((String) useTyp) ) {
            	...
            	Object selItems  = Preferences.get("ExportWordListDialog.LastSelectedItems", transcription);
        ...
        if (useTyp == null) {        	
    		useTyp = Preferences.get("ExportWordListDialog.tierRB", null);
        	if(useTyp !=null){
        		if((Boolean)useTyp){
        		...
        		useTyp = Preferences.get("ExportWordListDialog.typeRB", null);
            	if(useTyp != null){
            		if((Boolean)useTyp){
            			setSelectionMode(AbstractTierSortAndSelectPanel.BY_TYPE);
            		} else {
	...
	protected void extractTiersFromFiles() {
        ...
        Object useTyp = Preferences.get("ExportWordListDialog.SelectTiersMode", null);
        if (useTyp instanceof String) {
        	//List list = (List) Preferences.get("ExportWordListDialog.HiddenTiers", transcription);
        	//setSelectedMode((String)useTyp, list);   
        	setSelectionMode((String)useTyp);
    ...
    {
    	if(mode == WORDS){         
    		Object useTyp = Preferences.get("ExportWordListDialog.customDelimRB", null);
        	if(useTyp != null){
        		customDelimRB.setSelected((Boolean)useTyp); 
        	}
         
        	useTyp = Preferences.get("ExportWordListDialog.defaultDelimRB", null);
        	if(useTyp != null){
        		defaultDelimRB.setSelected((Boolean)useTyp); 
        	}
         
        	useTyp = Preferences.get("ExportWordListDialog.countTokensCB", null);
        	if(useTyp != null){
        		countTokensCB.setSelected((Boolean)useTyp); 
        	}
         
        	useTyp = Preferences.get("ExportWordListDialog.customDelimField", null);
        	if(useTyp != null){
        		customDelimField.setText(useTyp.toString()); 
        	}    		
    	} else{
        	Object useTyp = Preferences.get("ExportAnnotationListDialog.countTokensCB", null);
        	if(useTyp != null){
        		countTokensCB.setSelected((Boolean)useTyp); 
        	}   
    	}
