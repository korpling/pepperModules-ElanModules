...
public class ExportFilmStripDialog extends ClosableDialog
    ...
    private void initComponents() {
        ...
        widthSpinner = new JSpinner(new SpinnerNumberModel(120, 10, 2000, 5));
        ...
        skipSpinner = new JSpinner(new SpinnerNumberModel(2, 1, 100, 1));
        ...
        heightSpinner = new JSpinner(new SpinnerNumberModel(120, 20, 400, 5));
    ...
    {
    	Object useTyp = Preferences.get("ExportFilmStripDialog.everyRB", null);
    
    	if(useTyp != null){
    		everyRB.setSelected((Boolean)useTyp); 
    	}	
     
    	useTyp = Preferences.get("ExportFilmStripDialog.skipRB", null);
    	if(useTyp != null){
    		skipRB.setSelected((Boolean)useTyp); 
    	}
     
    	useTyp = Preferences.get("ExportFilmStripDialog.includeFrameTC", null);
    	if(useTyp != null){
    		includeFrameTC.setSelected((Boolean)useTyp); 
    	}
     
    	useTyp = Preferences.get("ExportFilmStripDialog.includeWavCB", null);
    	if(useTyp != null){
    		includeWavCB.setSelected((Boolean)useTyp); 
    	}
     
    	useTyp = Preferences.get("ExportFilmStripDialog.rulerVisCB", null);
    	if(useTyp != null){
    		rulerVisCB.setSelected((Boolean)useTyp); 
    	}
     
    	useTyp = Preferences.get("ExportFilmStripDialog.separateRB", null);
    	if(useTyp != null){
    		separateRB.setSelected((Boolean)useTyp); 
    	}
     
    	useTyp = Preferences.get("ExportFilmStripDialog.mergedRB", null);
    	if(useTyp != null){
    		mergedRB.setSelected((Boolean)useTyp); 
    	}
     
    	useTyp = Preferences.get("ExportFilmStripDialog.blendedRB", null);
    	if(useTyp != null){
    		blendedRB.setSelected((Boolean)useTyp); 
    	}
    }
