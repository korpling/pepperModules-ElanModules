...
public class EAF2SMIL {
    ...
    public static void export2SMIL(File eafFile, File smilFile,
        String[] tierNames, long offset, int  minimalDur, HashMap fontSettingHashMap) throws IOException, TransformerException {
     ...
     */
    public static void export2SMIL(File eafFile, File smilFile,
        String[] tierNames, String mediaURL, long offset, int  minimalDur, HashMap fontSettingHashMap)
    ...
    public static void export2SMIL(URL eafURL, File smilFile,
        String[] tierNames, String mediaURL, long offset, int  minimalDur, HashMap fontSettingMap)
        throws IOException, TransformerException {
        ...
        transformer2smil.transform(new StreamSource(eafURL.openStream()),
            new StreamResult(new FileOutputStream(smilFile)));
        ...
        for (int i = 0; i < tierNames.length; i++) {
            ...
            transformer2rt.transform(new StreamSource(eafURL.openStream()),
                new StreamResult(new FileOutputStream(rtFile)));
        }
    ...
    public void export2SMIL(File eafFile, File smilFile, String[] tierNames,
        long beginTime, long endTime,long offset, int  minimalDur, boolean recalculateTime, HashMap fontSettingHashMap) throws IOException, TransformerException {
     ...
     */
    public static void export2SMIL(File eafFile, File smilFile,
        String[] tierNames, String mediaURL, long beginTime, long endTime, long offset, int  minimalDur, boolean recalculateTime, HashMap fontSettingHashMap)
        throws IOException, TransformerException {
        try {
            URL eafURL = new URL("file:///" + eafFile.getAbsolutePath());
